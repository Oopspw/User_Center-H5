<template>
  <div v-title="$route.meta.title">
    <section>
      <div class="div_img01"><img src="../assets/images/bank01.png" alt="" width="100%"></div>
      <div class="div_img02"><img src="../assets/images/bank02.png" alt="" width="100%"></div>
      <div class="div_img03"><img src="../assets/images/bank03.png" alt="" width="100%"></div>
      <div class="div_img04"><img src="../assets/images/bank04.png" alt="" width="100%"></div>
      <div class="div_img05"><img src="../assets/images/bank05.png" alt="" width="100%"></div>
      <div class="div_img06"><img src="../assets/images/bank06.png" alt="" width="100%"></div>
    </section>
  </div>
</template>
<script>
